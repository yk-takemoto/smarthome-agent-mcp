...
export class DeviceControlClient {
  ...
  constructor(
    ...
    const transport = new StdioClientTransport({
      ...
      args: [`${this.devCtlConfig.devCtlServerRootPath}/build/index.js`],
      env: {
        ...
        SWITCHBOT_FUNCTION_DEVICEIDS_MAP:
          this.devCtlConfig.devCtlFunctionDeviceIdsMap,
        ...(this.nodeExtraCaCerts
          ? { NODE_EXTRA_CA_CERTS: this.nodeExtraCaCerts }
          : {}),
      },
    });
  ...
  async callToolResultSchema(tool: {
    name: string;
